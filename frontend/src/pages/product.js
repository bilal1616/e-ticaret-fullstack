...
function ProductComponent() {
    ...
    const remove = async (_id) => {
        let confirm = window.confirm("Seçili Ürünü Silmek İstiyormusunuz?");
        if (confirm) {
            let model = { _id: _id };
                            ...
                            <div className="modal-body">
                                ...
                                <div className='form-group'>
                                    ...
                                    <select className='form-control' value={categoryName} onChange={(e) => setCategoryName(e.target.value)}>
                                        ...
                                        <option>Mobilya Seti</option>
                                        <option>Prematüre Set</option>
                                    </select>
                                </div>
                                ...
                                <div className='form-group mt-2'>
                                    <label htmlFor='price'>Birim Fyatı</label>
