...
const uri = "mongodb+srv://MongoDb:1@reacteticaretdb.zeiv6mi.mongodb.net/test"
...
// User Collection (Kullanıcı) Bölümü
...
// User Collection Bölümü


// Product Collection (Ürün) Bölümü
...
// Product Collection Bölümü


// Basket Collection (Sepet) Bölümü
...
// Basket Collection Bölümü


// Order Collection (Sipariş) BölÜmÜ
...
// Add Product (ÜrÜn Ekleme) Bölümü
...
// Remove Product (ÜrÜn Silme) BölÜmÜ
app.post("/products/remove", async (req, res)=>{
    try {
        const {_id} = req.body;
        await Product.findByIdAndRemove(_id);
        res.json({message: "ÜrÜn silme işlemi başarıyla gerçekleşti!"});
    } catch (error) {
        res.status(500).json({message: error.message});
    }
})
// Remove Product Bölümü
